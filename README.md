...
I also went with a layered (controller, service, repository) architecture, which may not be the best choice for a small task like this, however I wanted to showcase my ability to think about future-proofness, if that is a word.
